  ...
  const items: Item[] = [
    {
      ...
      quote: "Badminton is not only about winning. What is important to me is about playing hard, doing my best and putting up a good show for the spectators.",
      name: 'Lin Dan',
      role: 'Chinese Badminton Player'
    },
    {
      img: TestimonialImg02,
      quote: "I want to be the best, it's not about the ranking, it's about being consistent and being the best in your own game.",
      name: 'Saina Nehwal',
    ...
    },
    {
      ...
      name: 'Lee Chong Wei',
      role: 'Malaysian Badminton Player'
    }
  ]
